# Determine architecture upfront
if (CMAKE_SYSTEM_PROCESSOR MATCHES "^(x86_64|AMD64|amd64)$")
    set(QL_MVN_ARCH "amd64")
elseif (CMAKE_SYSTEM_PROCESSOR MATCHES "^(aarch64|ARM64|arm64)$")
    set(QL_MVN_ARCH "arm64")
else ()
    set(QL_MVN_ARCH "unknown")
endif ()
...
if (WIN32)
    ...
    if (QL_MVN_ARCH STREQUAL "unknown")
    ...
    cmake_path(APPEND QL_MVN_SWIG_JAVA_RESOURCES_NATIVE_DIR windows/${QL_MVN_ARCH})
elseif (CMAKE_SYSTEM_NAME STREQUAL "Linux")
    ...
    cmake_path(APPEND QL_MVN_SWIG_JAVA_RESOURCES_NATIVE_DIR linux/${QL_MVN_ARCH})
elseif (APPLE)
