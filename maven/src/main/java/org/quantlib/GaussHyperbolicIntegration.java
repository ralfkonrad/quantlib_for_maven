...
public class GaussHyperbolicIntegration extends GaussianQuadrature implements AutoCloseable {
  ...
  protected static long swigRelease(GaussHyperbolicIntegration obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
